...
var stateWord = []stateDefinition {
	{flag: 1,    name: "state_sourcepump",  module: "geo",     usage: 1}, // 'Status Quellenpumpe'
	{flag: 2,    name: "state_heatpump",    module: "main",    usage: 1}, // 'Status Heizungsumwälzpumpe'
	{flag: 4,    name: "state_evd",         module: "geo",     usage: 1}, // 'Status Freigabe Regelung EVD/Magnetventil'
	{flag: 8,    name: "state_comp1",       module: "comp1",   usage: 1}, // 'Status Verdichter 1'
	{flag: 16,   name: "state_comp2",       module: "comp2",   usage: 1}, // 'Status Verdichter 2'
	...
	{flag: 256,  name: "state_water",       module: "water",   usage: 1}, // 'Status Motorventil Warmwasser'
	{flag: 512,  name: "state_pool",        module: "pool",    usage: 1}, // 'Status Motorventil Pool'
	{flag: 1024, name: "state_solar",       module: "solar",   usage: 1}, // 'Status Solarbetrieb'
	{flag: 2048, name: "state_cooling4way", module: "cooling", usage: 1}, // 'Status 4-Wegeventil im Kältekreis'
}
